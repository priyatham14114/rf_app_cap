        ...
        return Controller.extend("com.app.rfapp.controller.Home", {
            ...
            onSubmitPress: function () {
                ...
                const oPayload = {
                  ...
                  Area: "TEST",
                  Resourcegroup: "TEST",
                  Email: "TEST@ARTIHCUS.COM",
                  Phonenumber: "6301404368",
                  Notification: "TEST2",
                  Notifysupervisor: "TEST",
                  Status: "TEST",
                  Password: "12345678",
                ...
                oModel.update("/RESOURCESSet('007')", oPayload, {
                  success: function (oData, resp) {
                    if (oData) {
                        MessageBox.success("Test passed, updated");
                    } else {
                        MessageBox.warning("Update successful but no data returned.");
                    }
                  },
                  error: function (err) {
                    MessageBox.error("update failed Error: " + err.message);
                  }
                });
              },
              
            // test end
            onSubmitPresss: function () {
